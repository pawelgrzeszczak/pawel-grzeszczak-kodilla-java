...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfUserWith0Books() {
        ...
        LibraryUser libraryUser = new LibraryUser("Adam", "Kowalski", "11111111111");
        when(libraryDatabase.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf0Books);
    ...
    public void testListBooksInHandsOfUserWith1Books() {
        ...
        LibraryUser libraryUser = new LibraryUser("Adam", "Kowalski", "11111111111");
        when(libraryDatabase.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf1Books);
